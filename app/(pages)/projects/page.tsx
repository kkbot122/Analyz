...
import { ArrowUpRight, Plus, Activity, FolderDot, User } from "lucide-react";
...
const RoleBadge = ({ role }: { role: string }) => {
  ...
  return (
    <span
      className={`text-[10px] font-bold px-2.5 py-1 rounded-full uppercase tracking-wider ${colorClass}`}
    >
      {label}
    </span>
  );
      ...
      <main className="flex-1 px-4 lg:px-8 py-8 overflow-y-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Activity className="w-4 h-4 text-[#ed6c42]" />
              Demo
            </Link>
        ...
        {org.projects && org.projects.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 bg-white rounded-[32px] border border-gray-100 shadow-sm text-center">
            ...
            <p className="text-gray-500 mb-8 max-w-sm mx-auto leading-relaxed">
              Create your first project to start tracking analytics and managing
