    ...
    try {
      const res = await fetch("/api/invite", {
        ...
        body: JSON.stringify({
          email,
          projectId,
          role: "TEAM_MEMBER", // Default org role for project invites
          projectRole: role, // The actual project role
          organizationId,
        }),
      });
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span
                    className={`block text-xs mt-1 ${
                      role === "MEMBER" ? "text-blue-700" : "text-gray-500"
                    }`}
                  >
                    Standard access
                  </span>
                ...
                >
                  ...
                  <span
                    className={`block font-medium text-sm ${
                      role === "OWNER" ? "text-blue-900" : "text-gray-900"
                    }`}
                  >
                    Manager
                  </span>
                  <span
                    className={`block text-xs mt-1 ${
                      role === "OWNER" ? "text-blue-700" : "text-gray-500"
                    }`}
                  >
